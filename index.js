...
app.post("/add", async(req, res) => {
    ...
    try {
        ...
        console.log(err);
        res.status(500).send("This book already exists")
    }
});
...
app.post("/update", async(req, res) => {
    ...
    try {
        await db.query("UPDATE books SET title = $1, description = $2, rating = $3 WHERE isbn = $4", [updatedTitle, updatedDescription, updatedRating, updatedIsbn]);
